...
# Contact: fidic.biomath@gmail.com, caraortizmah@gmail.co

# script_joincoorspdb_to_mop.sh
...
then
  ...
  echo "Executing script_pdb_to_mop.sh over "$arg", "$org ", "$tag " and "$listm in $PWD...
fi
#########################################################################
